...
// Migrate target (local copy of live)
$aliases['d6.drupal.org.nz.local'] = array(
  'root' => '/var/www/drupal.org.nz/d6',
  'uri' => 'http://d6.local.drupal.org.nz',
  'databases' => array (
      'default' => array (
          'default' => array (
              'driver' => 'mysql',
...
// Migrate source (real live)
$aliases['d6.drupal.org.nz'] = array(
  'root' => '/var/www/drupalnetnz/live.taranto',
  'uri' => 'http://drupal.org.nz',
)+ $aliases['server'];
